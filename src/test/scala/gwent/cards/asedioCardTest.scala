...
class asedioCardTest extends FunSuite{
  ...
  val card1: AsedioCard = new AsedioCard(namesAsedio(0), 1, List(ataquesAsedio(0)))
  val card2: AsedioCard = new AsedioCard(namesAsedio(0), 1, List(ataquesAsedio(0)))
  val card3: AsedioCard = new AsedioCard(namesAsedio(1), 2, List(ataquesAsedio(1)))
  val card4: AsedioCard = new AsedioCard(namesAsedio(2), 2, List(ataquesAsedio(2)))
