...
class aDistanciaCardTest extends FunSuite{
  ...
  val card1: ADistanciaCard = new ADistanciaCard(namesADistancia(0), 1, List(ataquesADistancia(0)))
  val card2: ADistanciaCard = new ADistanciaCard(namesADistancia(0), 1, List(ataquesADistancia(0)))
  val card3: ADistanciaCard = new ADistanciaCard(namesADistancia(1), 2, List(ataquesADistancia(1)))
  val card4: ADistanciaCard = new ADistanciaCard(namesADistancia(2), 2, List(ataquesADistancia(2)))
